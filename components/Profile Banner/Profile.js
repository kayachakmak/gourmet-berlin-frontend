...
export default function Profile() {
  ...
  return (
    <div className="bg-banner dark:bg-banner">
      {user != null ? (<div className="flex justify-between" > 
        ...
        <div className="flex justify-end">
         <a href="/login" className="mr-2 inline-flex items-center justify-center px-4 py-1 text-base font-bold leading-6 text-white bg-indigo-600 border border-transparent rounded-full sm:w-auto hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">Login</a>
         <a href="/register" className="mr-2 inline-flex items-center justify-center px-4 py-1 text-base font-bold leading-6 text-white bg-indigo-600 border border-transparent rounded-full sm:w-auto hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">Register</a>
        </div>
      )}
    </div>
  );
